...
from detectionFunctions import find_filter_contours
...
# Prepare CSV file
csv_filename = "filtered_contour_data_benign_6.csv"
fieldnames = [
...
image = cv2.imread('images/hateful_0065.png')
image_copy = image.copy()
img_bin = preprocess_meme(image_copy)
print(type(img_bin))
contours_01 = find_filter_contours(img_bin,(0.9,1.40),(17,21),False, True)
